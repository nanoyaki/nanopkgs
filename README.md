...
- `openrgb` -> `release_candidate_1.0rc2-unstable-2026-05-04`
- `osu-lazer-bin` -> `2026.429.0-lazer`
- `prefetch`
- `prowlarr` -> `2.3.7.5365`
- `pyon` -> `2.1.4`
- `rofi-themes` -> `0-unstable-2026-04-30`
- `shoko` -> `0-unstable-2026-05-05`
- `shoko-webui` -> `0-unstable-2026-04-25`
- `shokofin` -> `0-unstable-2026-04-26`
- `startvrc`
- `suwayomi-server` -> `0-unstable-2026-05-05`
- `suwayomi-webui` -> `0-unstable-2026-05-05`
- `whisparr` -> `3.1.0.2116`
- `wkeys` -> `0-unstable-2026-02-16`
- `writeSystemdToggle`
- `zigbee2mqtt` -> `2.10.0-unstable-2026-05-01`
