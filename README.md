...
- `dwproton-bin` -> `10.0-20`
- `error-pages` -> `0-unstable-2024-11-22`
- `fireshare` -> `1.5.0-unstable-2026-03-13`
- `flaresolverr` -> `3.4.6`
- `jellyfin-web-with-plugins`
- `meow` -> `2.1.5`
- `midnight-theme` -> `0-unstable-2026-03-13`
- `oldlibcosmicAppHook`
- `openrgb` -> `release_candidate_1.0rc2-unstable-2026-03-10`
- `osu-lazer-bin` -> `2026.311.0-tachyon`
- `prefetch`
- `prowlarr` -> `2.3.3.5296`
- `pyon` -> `0.1.0`
- `rofi-themes` -> `0-unstable-2025-07-26`
- `shoko` -> `6.0.0-dev.44-unstable-2026-03-13`
...
- `suwayomi-webui` -> `20251230.01-unstable-2026-03-14`
- `whisparr` -> `3.1.0.2116`
