...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  midnight-theme = {
    ...
    version = "a452ae90b284b53b0ab0743080819a630468d404";
    src = fetchgit {
      url = "https://github.com/refact0r/midnight-discord.git";
      rev = "a452ae90b284b53b0ab0743080819a630468d404";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-z/pef9peg7jlgaylYiLyhBWX6GLy6x1AI9H77QKo1Jw=";
    };
    date = "2025-07-31";
  };
  openrgb = {
  ...
  shokofin = {
    pname = "shokofin";
    version = "5.0.4-dev.14";
    src = fetchTarball {
      url = "https://github.com/ShokoAnime/Shokofin/archive/refs/tags/v5.0.4-dev.14.tar.gz";
      sha256 = "sha256-ztQKYnKlNwSBmwagpoRuOtF9iSzW3jd89reMr4mYlTs=";
    };
  };
  suwayomi-server = {
    pname = "suwayomi-server";
    version = "7e211ee9a1319233461b71a48765c70bd6e96582";
    src = fetchgit {
      url = "https://github.com/Suwayomi/Suwayomi-Server.git";
      rev = "7e211ee9a1319233461b71a48765c70bd6e96582";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-ppDkh7ALLi6U6uS7b0H4DYvB7l4/EHTj1eLV7nYOceI=";
    };
    date = "2025-07-31";
  };
  suwayomi-webui = {
    pname = "suwayomi-webui";
    version = "cd04be7f5283eb38fb1fb80f14c8e9006fa7fef9";
    src = fetchgit {
      url = "https://github.com/Suwayomi/Suwayomi-WebUI.git";
      rev = "cd04be7f5283eb38fb1fb80f14c8e9006fa7fef9";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-yVArj4PZq7vXEvwwVxu4qFwm4kaSnrvwD2/sn9aTx1E=";
    };
    date = "2025-07-31";
  };
  tokenstream = {
