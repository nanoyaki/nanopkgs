...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  avdump = {
    pname = "avdump";
    version = "7f3f7259e332b56d1f2dc6bb9f29bc4aa7e28c4a";
    src = fetchgit {
      ...
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-5PxFI9+m83ZRdUM+vZ00Ag4pI/7OtnLwsSUK3bps8dU=";
    };
    date = "2024-03-10";
  };
  beet = {
  ...
  shoko = {
    pname = "shoko";
    version = "dffc184af21e94e3c7cb51f13b887911baf75f9a";
    src = fetchgit {
      url = "https://github.com/ShokoAnime/ShokoServer.git";
      rev = "dffc184af21e94e3c7cb51f13b887911baf75f9a";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
  ...
  shoko-webui = {
    pname = "shoko-webui";
    version = "04deb2df872070ccab366b739b48441d1441b277";
    src = fetchgit {
  ...
  shokofin = {
    pname = "shokofin";
    version = "f896870ab35cd508afcf50b4483f0dc3a9aa4616";
    src = fetchgit {
  ...
  suwayomi-webui = {
    ...
    version = "36477d1c9501cd005526154984c89f8cc98228d6";
    src = fetchgit {
      url = "https://github.com/Suwayomi/Suwayomi-WebUI.git";
      rev = "36477d1c9501cd005526154984c89f8cc98228d6";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-Nu+8KojiravT1Rq8Bl+FGlwfhaLma6g+GKfNx+ySM/M=";
    };
    date = "2025-11-17";
  };
  tokenstream = {
